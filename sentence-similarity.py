...
# reading the data from the files into a list of sentences1, sentences2 and similarity scores
sentences1=[]
sentences2=[]
all_sentences=[]
similarity_score=[]
with open("C:\\Users\\sanji\\Desktop\\sts-train.csv",'r',encoding='utf-8') as f:
    data = csv.reader(f)
    for row in data:
        if row[5]!='' and row[6]!='':
...
with open("C:\\Users\\sanji\\Desktop\\trying-results.csv",'w+',encoding='utf-8') as g:
    for i in range(0,len(sentences1)):

        # sentences
        g.write(sentences1[i]+"\t")
        g.write(sentences2[i]+"\t")
